package com.example.a201b011_complexsd;
...
public class MainActivity extends AppCompatActivity {
    ...
    String []winnersArray = {"Abhishek","Anant","Aniruddh"};
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sharedPreferences = this.getSharedPreferences("com.example.a201b011_complexsd" , Context.MODE_PRIVATE);
